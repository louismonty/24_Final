...
/    private PlayerController playerController = new PlayerController();
    ...
    public void matadorGameloop()
    {
        ...
        while(isGameRunning) {
            ...
            rules.hasGetOutOfJailCard(fieldController,currentPlayer,playerController.getPlayerArray(),guiController,GuiPlayers[currentPlayer.getPlayerId()],GuiPlayers,chanceCardController);

            rollDice(currentPlayer, GuiPlayers);

            rules.overStartRule(currentPlayer, guiController);
            //landonField
